...
const ALLOWED_PREFIXES = ["apps/", "packages/", "docker/", "docs/", "scripts/", "public/", ".github/"];
...
const FORBIDDEN_BASENAMES = ["CLAUDE.md", "AGENTS.md", ".env", "skills-lock.json"];

const FORBIDDEN_GLOBS = [/\.env\..*/, /\.code-workspace$/, /\.jsonl$/];
